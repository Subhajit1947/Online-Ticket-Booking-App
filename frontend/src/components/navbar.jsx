        ...
        email ? <div className="login">
          <div className="loging">
            <div className="loghead">
              <div style={{ cursor: 'pointer' }} className="backdiv"><svg onClick={() => {
                signtoggle()
                emailtoggle()
...
C44.5,25.4,53.3,16.6,62,7.8c2-2,4-4,6-6C69.2,0.7,70.6,0,72.7,0z"></path></svg></div>
            ...
            <form className="logemail" action="">
              ...
              <br />
              <button style={{ cursor: 'pointer' }} onClick={logging} type="submit" class="btnlogmail">Login</button>
              <br />
              <span>dont have an account <span style={{ cursor: 'pointer', color: 'blue', textDecoration: 'underline' }} onClick={() => {
                emailtoggle()
                signuptoggle()
              }}>signup</span></span>
        ...
        signup ? <div className="signup">
          ...
          C44.5,25.4,53.3,16.6,62,7.8c2-2,4-4,6-6C69.2,0.7,70.6,0,72.7,0z"></path></svg></div>
            ...
            <form className="signupemail" action="">
              ...
              <input id="password" onChange={getting} type="password" />
              <br />
              <button onClick={signuping} style={{ cursor: 'pointer' }} type="submit" class="btnsignupmail">Sign up</button>
              <br />
          ...
          <div className="menu">
            <div className="menuinside">
              ...
              {/* <div className="menuheader">
                <h1>Hey!</h1>
                <h1 onClick={menutoggle}>xdsbsdcxz</h1>
              </div> */}
              <div className="menufooter">
              <div>
                <span>Get Started</span>
                {/* <span onClick={menutoggle} ><svg width="15" height="15" xmlns="http://www.w3.org/2000/svg"><title>Close</title><g fill="#666"><path d="M13.125 0l-7.5 7.5 7.5 7.5 1.429-1.428L8.482 7.5l6.072-6.071z"></path><path d="M1.429 0l7.5 7.5-7.5 7.5-1.43-1.428L6.072 7.5 0 1.43z"></path></g></svg></span>
               */}
              </div>
                <div><span><svg style={{cursor:'pointer'}} onClick={menutoggle} width="15" height="15" xmlns="http://www.w3.org/2000/svg"><title>Close</title><g fill="#666"><path d="M13.125 0l-7.5 7.5 7.5 7.5 1.429-1.428L8.482 7.5l6.072-6.071z"></path><path d="M1.429 0l7.5 7.5-7.5 7.5-1.43-1.428L6.072 7.5 0 1.43z"></path></g></svg></span><span>Hey!</span><span></span></div>
      ...
      <div className="navfirst">
        ...
        <div class="sc-eInJlc fIvCmI">
          <span onClick={() => takecity(null)} className="selectcity">{cities}
             <span className="arrow-down "></span> </span><div class="sc-jKVCRD hmbjRr">{tokens ? "" : 
              <div onClick={signtoggle} class="sc-chbbiW bQENkS">Sign in</div>}
              {tokens ? 
              <h4  style={{ color: "white", "display": "flex", "alignItems": "center" }} onClick={menutoggle}>
                <img style={{ width: "30px", height: "30px", "margin-right": "10px" }} src="//in.bmscdn.com/m6/images/my-profile/bms-user.png" alt="Profile" class="sc-kxynE fLWHdD" />Hi,User</h4> : <div class="sc-hzNEM hGOWBG"><svg onClick={menutoggle} width="22px" height="14px" xmlns="http://www.w3.org/2000/svg"><title>Hamburger Menu</title><g fill-rule="nonzero" stroke="#FFF" stroke-width="1.5" fill="none" stroke-linecap="round"><path d="M1.611 1h20.614M1.611 7h20.614M1.611 13h20.614"></path></g></svg></div>} </div></div>
      </div>
